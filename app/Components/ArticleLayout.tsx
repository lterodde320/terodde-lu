  ...
  return (
    <div>
      <motion.div
        ...
        className="fixed top-0 right-0 p-5 w-fit h-fit z-40"
      >
        <Button
          variant="default"
          size="icon"
        ...
        >
          <X
            size={30}
            className=" cursor-pointer text-black dark:text-white border-none"
          />
        </Button>
      </motion.div>
      <motion.article className="max-w-[2000px] mx-auto">
        <motion.div
          ...
          className="relative w-full h-[50vh] min-h-[400px] z-30"
        >
          {background}
