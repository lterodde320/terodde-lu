...
const features = [
    {
        ...
        background: (
            <Image
                ...
                style={{ maskImage: "radial-gradient(circle at 120% 50%, white 65%, transparent 95%)" }}
            />
        ),
        ...
        background: (
            <div>
                <Image
                    ...
                    className={`bg-gray-900 absolute opacity-100 w-full h-full object-contain bottom-0 right-0 overflow-visible`}
                />
                <div className="absolute bottom-0 right-0 w-full h-full bg-black opacity-50" style={{ maskImage: "linear-gradient(to bottom, transparent 20% , black 80%)" }} />
            </div>),
